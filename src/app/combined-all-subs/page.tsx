                    ...
                    return (
                      <tr key={row.id}>
                        ...
                        {effectiveDisplayMode === "arr" ? (
                          ...
                          <>
                            <td>{formatPlanLabel(row.hubspotPlansByPeriod?.[lastKey] || "free")}</td>
                            <td>{formatPlanLabel(row.stripePlansByPeriod?.[lastKey] || "free")}</td>
                            <td>{formatPlanLabel(row.plansByPeriod?.[lastKey] || "free")}</td>
                            {data?.periods.map((period) => (
